...
static const u8 sCorrosionDescription[] = _("Poison is supereffective against steel types.");
...
static const u8 sDiscourageDescription[] = _("Lowers Special Attack on Entry.");
...
const u8 gAbilityNames[ABILITIES_COUNT][ABILITY_NAME_LENGTH + 1] =
{
    ...
    [ABILITY_DISCOURAGE] = _("Discourage"),
};
...
const u8 *const gAbilityDescriptionPointers[ABILITIES_COUNT] =
{
    ...
    [ABILITY_DISCOURAGE] = sDiscourageDescription,
};